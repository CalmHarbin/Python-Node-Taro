...
def getCookie(key_world):
    '''
        @method 获取cookie
    '''
    global COOKIE, UserAgent, city, ip_table
    ...
    try:
        ...
        data = requests.get('https://www.lagou.com/jobs/list_' + key_world + '?px=default&city=' + city, timeout=10, headers={
...
def getData(obj):
    ...
    # print('开始抓取' + key_world + '第' + str(page) + '页)
    print('开始')
    # 连接数据表,前端需要转为web表,
